...
const VolunteerReceived = () => {
    ...
    const fetchDonations = async () => {
        try {
            setLoading(true);
            const donationList = await axiosInstance.get(`volunteer/received-donation`);
    ...
    useEffect(() => {
        if (isFocused) {
            fetchDonations(); // ✅ Fetch data when tab/screen is active
        }
    }, [isFocused]);
...
export default VolunteerReceived;
